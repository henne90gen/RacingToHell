...
AICar::AICar(int level, int roadSpeed, sf::Texture& texture) : Car(sf::Vector2f(0, 0), 65 + level * 25, std::rand() % ((int)(roadSpeed / 3)) + ((int)(roadSpeed / 3)), GameObjectType::AI, texture)
{
	_Lane = std::rand() % 4;
