...
MainMenu::MainMenu() : Menu(GameState::Main)
{
	...
	std::shared_ptr<MenuButton> button6(new MenuButton(sf::Vector2f(SCREENWIDTH / 2 - 60, SCREENHEIGHT - 335), sf::Vector2f(0, 50), MenuResult::PreviousSkin, "<<", TextAlignment::Left));
	_MenuItems.push_back(button6);
	std::shared_ptr<MenuButton> button7(new MenuButton(sf::Vector2f(SCREENWIDTH / 2 + 50, SCREENHEIGHT - 335), sf::Vector2f(0, 50), MenuResult::NextSkin, ">>", TextAlignment::Left));
