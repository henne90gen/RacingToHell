...
public:
    ...
    */
    Jet(unsigned int id, int difficulty, int HP, sf::Texture &texture, sf::Texture &bulletTexture,
        sf::SoundBuffer &soundBufferEngine);

    Jet(sf::Packet &packet, sf::Texture &texture, sf::Texture &bulletTexture, sf::SoundBuffer &soundBufferEngine);
