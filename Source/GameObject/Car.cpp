...
Car::Car(unsigned int id, GameObjectManager &gom, sf::Vector2f pos, int maxhealth, float speed, GameObjectType Type,
         sf::Texture &texture,
         sf::IntRect textureRect) :
        GameObject(id, gom, Type, pos, texture, textureRect) {
    _Speed = speed;
