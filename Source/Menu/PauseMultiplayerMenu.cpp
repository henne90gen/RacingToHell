...
PauseMultiplayerMenu::PauseMultiplayerMenu() :
	Menu(GameState::PauseMultiplayer)
{
	...
	std::shared_ptr<MenuButton> button3(new MenuButton(sf::Vector2f(SCREENWIDTH / 2, 380), ButtonSize, MenuResult::Back, "Leave this Game", TextAlignment::Center));
...
GameState PauseMultiplayerMenu::handleEvents(sf::RenderWindow & window)
{
