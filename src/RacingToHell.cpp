...
Texture readBmpIntoMemory(File f, GameMemory* memory) {return {};}
namespace Sound {

void getSoundSamples(GameMemory* memory, SoundOutputBuffer* buffer) {}
}
//#include "Helper.cpp"
//#include "Init.cpp"
...
UPDATE_AND_RENDER(updateAndRender) {
	circle(buffer, { 500, 700 }, 100, 0xffff0000);
